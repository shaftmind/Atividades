...
io.on("connection", function(socket){
    ...
    socket.on("entrar", function(nome, callback){
        if(!(nome in usuarios)){
            ...
            var mensagem = "[ " + pegarDataAtual() + " ] " + nome + " acabou de entrar na sala";
    ...
    socket.on("enviar mensagem", function(dados, callback){
        ...
        mensagem_enviada = "[ " + pegarDataAtual() + " ] " + socket.nome + " diz: " + mensagem_enviada;
...
function pegarDataAtual(){
    ...
    var dataFormada = dia + "/" + mes + "/" + ano + " " + hora + ":" + minuto + ":" + segundo;
    return dataFormada;
